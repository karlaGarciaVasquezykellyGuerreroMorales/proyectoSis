...
require_once 'candidato.entidad.php';
require_once 'candidato.model.php';
...
if(isset($_REQUEST['action']))
{
    switch($_REQUEST['action'])
    {
        case 'actualizar':
            ...
            $alm->__SET('Partido',          $_REQUEST['Partido']);

            $model->Actualizar($alm);
            header('Location: recandidato.php');
            break;
...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="http://yui.yahooapis.com/pure/0.5.0/pure-min.css">
         <h1>BIENVENIDO AL SISTEMA DE REGISTRO DE CANDIDATOS</h1><hr>
...
<h3><a id="pregunta" href= "../welcome.php">MENU PRINCIPAL</a><br></h3>
    ...
    <title>registro_candidato</title>
        ...
        <div class="pure-g">
            <div class="pure-u-1-12">
                ...
                <form action="?action=<?php echo $alm->id > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:30px;">
                    <input type="hidden" name="id" value="<?php echo $alm->__GET('id'); ?>"  value="" class="form-control" required=""/>
                    
                    <table style="width:500px;">
                        <tr>
                            <th style="text-align:left;">Dui</th>
                            <td><input type="text" name="Dui" maxlength="10" placeholder="00000000-0" value="<?php echo $alm->__GET('Dui'); ?>" style="width:100%;"  value="" class="form-control" required=""/></td>
                        </tr>
                        <tr>
                       ...
                       <tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <select name="Bandera" style="width:100%;" style="width:100%;"  value="" class="form-control" required=""/>
                         ...
                         <tr>
                            ...
                            <td>
                                <select name="Partido" style="width:100%;"  value="" class="form-control" required=""/>
                                    <option value="1" <?php echo $alm->__GET('Partido') == 1 ? 'selected' : ''; ?>>ARENA</option>
                                    <option value="2" <?php echo $alm->__GET('Partido') == 2 ? 'selected' : ''; ?>>FMLN</option>
                                </select>
                            </td>
                        </tr>
                ...
                <table class="pure-table pure-table-horizontal">
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            ...
                            <td><?php echo $r->__GET('Partido') == 1 ? 'ARENA' : 'FMLN'; ?></td>
                            <td>
